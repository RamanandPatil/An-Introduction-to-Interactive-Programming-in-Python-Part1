# http://www.codeskulptor.org/#user43_TNTrHVj7f7_0.py

# Compute the number of feet corresponding to a number of miles.
# Given a template that pre-defines a variable miles, 
# write an assignment statement that defines a variable feet whose value is 
# the number of feet in miles miles.
