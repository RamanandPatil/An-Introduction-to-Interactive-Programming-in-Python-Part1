# http://www.codeskulptor.org/#user43_gG7WNKKkUh_0.py
...
# write an assignment statement that updates the variable
# total_seconds to have a value corresponding to the 
