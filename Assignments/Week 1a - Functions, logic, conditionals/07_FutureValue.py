# http://www.codeskulptor.org/#user43_whgBSfHtns_0.py
...
# present_value, annual_rate and years and returns the future value of present_value
...
def future_value(present_value, annual_rate, years):
    return present_value * math.pow((1 + 0.01 * annual_rate), years)
# Alternatively you can return like this (without using math function):
