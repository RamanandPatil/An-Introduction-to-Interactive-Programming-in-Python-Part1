# http://www.codeskulptor.org/#user43_VsTxJVoDQ1_0.py
...
# and last_name (strings) and returns a string of the form
# "My name is % %." where the percents are the strings first_name and last_name.
