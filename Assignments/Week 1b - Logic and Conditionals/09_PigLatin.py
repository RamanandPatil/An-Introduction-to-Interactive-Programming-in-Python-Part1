# http://www.codeskulptor.org/#user43_mtdWjpYS0v_0.py
...
# If the first letter in word is a consonant,
...
# The provided template includes code to extract
# the first letter and the rest of word in Python.
# Note that, in full Pig Latin, the leading consonant cluster is moved to
# the end of the word. However, we don't know enough Python to implement full Pig Latin just yet.
