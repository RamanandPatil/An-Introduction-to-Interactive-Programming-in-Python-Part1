# http://www.codeskulptor.org/#user43_Zy9UMzZrg2_0.py
...
# The quadratic formula x=−b±b2−4ac√2a can be used to compute these solutions.
...
# If the equation has no real solution, print the message "Error: No real solutions"
# and simply return.
...
#    My Solution
#    # Calculate discriminant  as b-square - 4ac
#    d = b ** 2 - 4 * a * c
#    
#    if d > 0:
#        return (-b - (d ** 0.5))/(2 * a)
